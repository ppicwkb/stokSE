            ...
            try {
                ...
                allData = rows.slice(1).map((row, index) => {
                    ...
                    return {
                        ...
                        estimasi:row[14] ||  '',              // Column O: ESTIMASI
                        total: parseNumber(row[15]),     // Column P: TOTAL
                        kekuranganMc: parseNumber(row[16]), // Column Q: KEKURANGAN MC
                        kekuranganHl: parseNumber(row[17])  // Column R: KEKURANGAN HL
                    };
        ...
        function renderFullTable() {
            ...
            allData.forEach(item => {
                ...
                row.innerHTML = `
                    ...
                    <td class="px-4 py-3 text-sm font-medium text-red-600">${item.kekuranganMc.toLocaleString('id-ID')}</td>
                    <td class="px-4 py-3 text-sm font-medium text-orange-600">${item.kekuranganHl.toLocaleString('id-ID')}</td>
